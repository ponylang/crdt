class ref TLog[
  ...
  considered duplicates of each other, and all but one will be discarded.
  ...
  those conflicts can also be resolved in a commutative, idempotent way.
  ...
  fun ref converge(that: TLog[A, T, B] box): Bool =>
    ...
    ignoring any duplicate entries, and respecting the cutoff timestamp.
